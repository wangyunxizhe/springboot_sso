package com.yuan.controller.cross.www.b.com;

import com.yuan.controller.cross.www.b.com.utils.Demo2Tool;
 ...
 */
@Controller("crossDemo2")
@RequestMapping("/crossdemo2")
public class Demo2Controller {
    ...
    public String doLogin(HttpServletRequest request,
        ...
        String rs = demo2Tool.doGet("http://www.x.com/cross/sso/doLogin", map);
        if (rs.equals("1")) {
    ...
    public String main(HttpServletRequest request) {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("ssoCookie")) {
                    ...
                    String rs = demo2Tool.doGet("http//www.x.com/cross/sso/checkCookie", map);
                    if (rs.equals("1")) {
                        return "cross/success2";
                    }
                }
        ...
        //给form表单中的path变量传值
        request.setAttribute("path", "crossdemo2");
        //这里必须要给完整路径了
        request.setAttribute("gotoURL", "http://www.b.com/crossdemo2/main");
        return "cross/login";
    }
